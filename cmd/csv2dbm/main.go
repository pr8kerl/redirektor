...
type DbmCommand struct {
	Db  string
	Csv string
	Ui  cli.Ui
}

func dbmCmdFactory() (cli.Command, error) {
	ui := &cli.BasicUi{
		Reader:      os.Stdin,
		Writer:      os.Stdout,
...
func (c *DbmCommand) Run(args []string) int {
...
func (c *DbmCommand) Synopsis() string {
